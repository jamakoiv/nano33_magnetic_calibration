...
class test_ellipsoid(unittest.TestCase):
    ...
    def test_makeEllipsoidXYZ(self) -> None:
        correct = np.array(
            [
                [10.0, 10.0, 35.0],
                [20.60660172, 10.0, 27.67766953],
                [25.0, 10.0, 10.0],
                [20.60660172, 10.0, -7.67766953],
                [10.0, 10.0, -15.0],
                [10.0, 10.0, 35.0],
                [10.0, 24.14213562, 27.67766953],
                [10.0, 30.0, 10.0],
                [10.0, 24.14213562, -7.67766953],
                [10.0, 10.0, -15.0],
                [10.0, 10.0, 35.0],
                [-0.60660172, 10.0, 27.67766953],
                [-5.0, 10.0, 10.0],
                [-0.60660172, 10.0, -7.67766953],
                [10.0, 10.0, -15.0],
                [10.0, 10.0, 35.0],
                [10.0, -4.14213562, 27.67766953],
                [10.0, -10.0, 10.0],
                [10.0, -4.14213562, -7.67766953],
                [10.0, 10.0, -15.0],
                [10.0, 10.0, 35.0],
                [20.60660172, 10.0, 27.67766953],
                [25.0, 10.0, 10.0],
